;;; packages.el --- leo-doxygen layer packages file for Spacemacs.
;;
...
;; added to `leo-doxygen-packages'. Then, for each package PACKAGE:
;;
;; - If PACKAGE is not referenced by any other Spacemacs layer, define a
;;   function `leo-doxygen/init-PACKAGE' to load and initialize the package.

;; - Otherwise, PACKAGE is already referenced by another Spacemacs layer, so
;;   define the functions `leo-doxygen/pre-init-PACKAGE' and/or
;;   `leo-doxygen/post-init-PACKAGE' to customize the package as it is loaded.

;;; Code:

(defconst leo-doxygen-packages
  '(
    custom
    xml-parse
    url
  ...
  "The list of Lisp packages required by the leo-doxygen layer.
...
(defcustom doxymacs-external-xml-parser-executable
  "/home/zhangbaoxian/bin/doxymacs_parser"
